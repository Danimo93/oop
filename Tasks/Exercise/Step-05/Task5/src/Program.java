...
public class Program {
    public void oppgave4() throws FileNotFoundException{
        ...
        System.out.println("Reading content in the file opg4.txt");
        while (fileReader.hasNextLine()){
            System.out.println(fileReader.nextLine());
        }
        fileReader.close();
        System.out.println("Don reading opg4.txt");
    }
    ...
    public void oppgave5() throws IOException{
        ...
        writer.close();
        System.out.println("Done writing content to opg5.txt");
    }
    ...
    public void oppgave8() throws IOException{
        ...
        System.out.println("Reading from opg7.txt");
        readArtists(artists, file);
        System.out.println("Changing some artists field");
        artists.get(0).setArtistName("Prince (the symbol)");
    ...
    public void writeArtistToFile(ArrayList<Artist> artists, String fileName) throws IOException {
    ...
    public void readArtists(ArrayList<Artist> artists, File file) throws FileNotFoundException {
        ...
        while(fileReader.hasNextLine()){
            ...
            artists.add(new Artist(artistName, bDate, city, country));
            fileReader.nextLine();
        }
        fileReader.close();
    }
